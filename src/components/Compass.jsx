    ...
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10}}>
      <svg width="88" height="88" viewBox="0 0 88 88">
        ...
        <g transform={`rotate(${deg},44,44)`}>
          <polygon points="44,7 47.5,34 44,30 40.5,34" fill="#0ea5e9"/>
          <polygon points="44,81 47.5,54 44,58 40.5,54" fill="#0ea5e9" opacity="0.2"/>
        </g>
        <circle cx="44" cy="44" r="5" fill={T.card} stroke="#0ea5e9" strokeWidth="2.5"/>
      </svg>
